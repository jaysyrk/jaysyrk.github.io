          ...
          >
            <div>
              ...
              <h3 className="text-2xl font-bold text-slate-800 mb-2 font-sans flex items-center gap-3">
                Lethe
                <a
                  href="https://github.com/jaysyrk/Lethe"
                  target="_blank"
                  rel="noopener noreferrer"
              ...
              <p className="text-xs font-mono text-[#e73737] mb-4 tracking-wide">High-Performance Honeypot</p>
            ...
            <div className="flex flex-wrap gap-2 mt-auto">
              {["Go", "Cybersecurity", "TCP Tarpit", "Honeypot", "Edge Proxy"].map((tag) => (
                <span
                  key={tag}
          ...
          >
            <div>
              ...
              <h3 className="text-2xl font-bold text-slate-800 mb-2 font-sans flex items-center gap-3">
                Apeiron
                <a
                  href="https://github.com/jaysyrk/Apeiron"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-slate-500 hover:text-[#e73737] transition-colors"
                >
            ...
            <div className="flex flex-wrap gap-2 mt-auto">
              {["React", "FastAPI", "Ollama", "ChromaDB", "Python", "RAG"].map((tag) => (
                <span
                  key={tag}
                  className="text-[10px] font-mono bg-[#e73737]/5 text-[#e73737] border border-[#e73737]/10 px-2.5 py-1 rounded"
                >
          ...
          >
            <div>
              ...
              <h3 className="text-2xl font-bold text-slate-800 mb-2 font-sans flex items-center gap-3">
                CodeStudio
                <a
                  href="https://github.com/nautilus-os/OfflineIDE"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-slate-500 hover:text-[#e73737] transition-colors"
                >
          ...
          >
            <div>
              ...
              <h3 className="text-2xl font-bold text-slate-800 mb-2 font-sans flex items-center gap-3">
                Rust Base64
                <a
                  href="https://github.com/jaysyrk/Rust-to-Base64-Encoder"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-slate-500 hover:text-[#e73737] transition-colors"
                >
              ...
              <p className="text-xs font-mono text-[#e73737] mb-4 tracking-wide">From-Scratch Implementation</p>

              <p className="text-slate-600 text-sm leading-relaxed mb-6 font-sans">
                A high-performance Base64 encoder and decoder written completely from scratch in Rust, without relying on external crates. Uses raw bitwise shifting and masking to manipulate bytes.
              </p>
            </div>

            <div className="flex flex-wrap gap-2 mt-auto">
              {["Rust", "CLI", "Algorithms", "Bitwise Ops"].map((tag) => (
                <span
                  key={tag}
                  className="text-[10px] font-mono bg-[#e73737]/5 text-[#e73737] border border-[#e73737]/10 px-2.5 py-1 rounded"
                >
          ...
          >
            <div>
              ...
              <h3 className="text-2xl font-bold text-slate-800 mb-2 font-sans flex items-center gap-3">
                symexec
                <a
                  href="https://github.com/jaysyrk/symexec"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-slate-500 hover:text-[#e73737] transition-colors"
                >
              ...
              <p className="text-xs font-mono text-[#e73737] mb-4 tracking-wide">Z3-Backed Engine</p>
            ...
            <div className="flex flex-wrap gap-2 mt-auto">
              {["Rust", "Z3", "SMT", "Reverse Engineering"].map((tag) => (
                <span
                  key={tag}
                  className="text-[10px] font-mono bg-[#e73737]/5 text-[#e73737] border border-[#e73737]/10 px-2.5 py-1 rounded"
                >
