      ...
      <section id="projects" className="max-w-5xl mx-auto px-6 py-24 relative z-10 scroll-mt-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <motion.div 
            ...
            className="flex flex-col justify-between p-6 rounded-2xl border border-slate-200/50 bg-white/50 backdrop-blur-sm hover:border-red-400/20 transition-all duration-300"
          >
            <div>
              <span className="font-mono text-[10px] text-red-400 bg-red-400/10 border border-red-400/20 px-2 py-0.5 rounded uppercase tracking-wider w-fit mb-4 block">
            ...
            <div className="flex flex-wrap gap-2 mt-auto">
              {["Python", "Machine Learning", "Dynamic Compilation", "Cryptographic Signatures", "Self-Healing Logic", "Concurrency"].map((tag) => (
                <span
                  key={tag}
                  className="text-[10px] font-mono bg-red-400/5 text-red-500 border border-red-400/10 px-2.5 py-1 rounded"
                >
                  {tag}
                </span>
              ))}
